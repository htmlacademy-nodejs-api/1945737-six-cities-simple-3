...
import DatabaseService from '../common/config/database-client/database.service.js';
...
import { DatabaseInterface } from '../common/config/database-client/database.interface.js';
